...
function characterInfo(name, imgID, hp, mp, rP, rR, rF, rE, rT, acurracy, speed, attack){
	return {name:name,imgID:imgID,hp:hp,mp:mp,rP:rP,rR:rR,rF:rF,rE:rE,rT:rT,acurracy:acurracy,speed:speed, attack:attack}
}
