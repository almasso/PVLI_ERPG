...
export default class CementeryScene extends Phaser.Scene {
	...
	*/
	...
	create() {
		...
		//#endregion
		//Imagen de fondo
		var bg = this.add.image(0, 0, 'clif').setOrigin(0, 0);
		...
		// creamos a manín
		this.manin = new Manin(this, 750, 125, this.scene.get('dialog'), this.questLog,"CEMENTERY");
		this.manin.setFlip(true,false);
		...
		// let npc3 = new NPC(this, 300, 200, 'jatsune', 2, npc_dialogues,this.manin);
		 let npc1 = new NPC(this, 485, 125, 'kratos', 10, npc_dialogues, this.manin);
	...
	ChangeScene()
    {
		...
		// generamos las hierbas que se nos digan (en este caso 16 porque, de nuevo, TEMPORAL)
				...
				this.frias.push(new enviromentObj(this,790,100 + 64, 'pixel',2.5,2.5));
